...
if agent.isTraining:
    for episode in range(episodes):
        ...
        if (episode + 1) % 50 == 0:
            ...
            if agent.save_model:
                agent.model.save('cartpole_dddqn_model.h5')
                print('model saved')
            if agent.save_graph:
                agent.draw(episode, episode_rewards, average_rewards, "./dddqn_training_cartpole.png")
        if (episode + 1) % 100 == 0:
            end_time = time.time()
    ...
    for episode in range(3000):
        ...
        while True:
            ...
            if done or rewards >= step_limit:
                ...
                break
    agent.draw(episode, episode_rewards, average_rewards, "./dddqn_random_cartpole.png")
    ...
    for episode in range(10):
        ...
        while True:
            ...
            if done or rewards >= step_limit:
                ...
                print(template.format(episode, rewards, max_reward, average_reward, "Not used"))
                break
    agent.draw(episode, episode_rewards, average_rewards, "./dddqn_playing_cartpole.png")
