...
class DQNAgent:
    def __init__(self):
        ...
        if self.load_model:
            ...
            self.model = tf.keras.models.load_model('cartpole_nstep.h5', custom_objects={'NoisyDense': NoisyDense(128, activation='relu'),
                                                                                         'GlorotUniform': glorot_uniform(), 'Zeros': zeros()})
            self.target_model = tf.keras.models.load_model('cartpole_nstep.h5', custom_objects={'NoisyDense': NoisyDense(128, activation='relu'),
                                                                                                'GlorotUniform': glorot_uniform(), 'Zeros': zeros()})
        else:
    ...
    def create_model(self):
        ...
        fc1 = NoisyDense(128, activation='relu')(inputs)
